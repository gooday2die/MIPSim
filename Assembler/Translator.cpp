...
/**
 * A member function for class Translator that translates into machine code from const char* expression.
 ...
 */
uint32_t Translator::generateMachineCode(const char* expression) {
